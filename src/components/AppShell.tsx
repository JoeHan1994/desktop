    ...
    <div className="flex h-full flex-col gap-3 overflow-hidden px-3 pb-3">
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          {/* 最小化 */}
          <button onClick={() => winAction('minimize')} className="glass glass-icon-button glass-control h-7 w-7 rounded-full">
            <svg viewBox="0 0 12 12" className="h-3 w-3" fill="currentColor"><rect x="1" y="5.5" width="10" height="1.2" rx="0.6" /></svg>
          </button>
          {/* 最大化 */}
          <button onClick={() => winAction('maximize')} className="glass glass-icon-button glass-control h-7 w-7 rounded-full">
          ...
          {/* 关闭 */}
          <button onClick={() => winAction('close')} className="glass glass-icon-button glass-control h-7 w-7 rounded-full hover:!bg-rose-500/80 hover:text-white">
